...
3. Part 2 仅从 Part 1 受控派生：4:3 横版、2K；只允许推导正面、左侧45°、右侧90°视角与上下区裁切排版，不得重新设计角色。
...
- 角色 validator 按 Part 校验精确字段顺序、唯一出现、禁止额外字段、固定画幅、Part 2 视图、Part 3 六格、Part 4 宫格/分页及 Part 1 引用。
- 新增 FAIL fixtures 覆盖旧 3:4 Part 2、字段合并、额外技能、错误画幅、Part 4 错误格数和自动敏感词。
